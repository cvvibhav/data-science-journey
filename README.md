...
* **Day 2:** Wrote my first Python script! (Variables & Data Types) (That special link format ##[link text](./path/to/file)## is called Markdown. It will create a direct link to your notebook.)
 - [See the code in `phase_1_python_basics/`](./phase_1_python_basics/Day_02_Python_Basics.ipynb)
